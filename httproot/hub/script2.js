...
const slider2 = document.getElementById("55");
const sV = document.getElementById("slider1");
const sVv = document.getElementById("slider2");
// Text which will show the value of the range slider.
const sliderValue = document.querySelector(".length__title");
const sliderValue2 = document.getElementById("44");
// Using Event Listener to apply the fill and also change the value of the text.
slider.querySelector("input").addEventListener("input", event => {
    sliderValue.setAttribute("data-length", event.target.value);
    sV.setAttribute("value", event.target.value)
	applyFill(event.target);
});
///////
slider2.querySelector("input").addEventListener("input", event2 => {
    sliderValue2.setAttribute("data-length", event2.target.value);
    sVv.setAttribute("value", event2.target.value)
	applyFill(event2.target);
});
